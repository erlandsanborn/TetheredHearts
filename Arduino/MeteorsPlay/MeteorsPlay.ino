...
int patternState = 2; // Keeps track of what the current light pattern is.
...
int meteorHue = 213; // Default meteor color is set to pink/purple.
int meteorVal = 160; // Default meteor brightness. 
int dustHue = 213; // Default dust color.
int dustVal = 213; // Default dust value.
...
int idleHue = 210; // Color during idleState/loadState.
